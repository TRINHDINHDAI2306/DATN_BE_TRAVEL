...
export class MailService {
  ...
  async sendApproveTourMail(approveTourEmailDto: ApproveTourEmailDto): Promise<void> {
  ...
  async sendAcceptOrderMail(aproveOrderEmailDto: ApproveOrderEmailDto): Promise<void> {
    await this.emailQueue.add('sendAcceptOrderMail', {
      ...aproveOrderEmailDto,
    })
  }
  async sendRejectOrderMail(aproveOrderEmailDto: ApproveOrderEmailDto): Promise<void> {
