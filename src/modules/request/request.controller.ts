...
export class RequestController {
  ...
  async createRequest(@Body() body: CreateRequestDto, @ActorID() userId: number): Promise<Response> {
  ...
  @Get('/user')
  @UseGuards(UserAuthGuard)
  async getMyRequest(@Query() options: GetUserRequestDto, @ActorID() userId: number): Promise<Response> {
    return this.requestService.getMyRequest(options, userId)
  }

  @Get('/tourguide')
  @UseGuards(TourGuideAuthGuard)
  async getListRequest(@Query() options: BasePaginationRequestDto, @ActorID() tourGuideId: number): Promise<Response> {
  ...
  @Delete('/user/:id')
  @UseGuards(UserAuthGuard)
  async deleteMyRequest(@Param('id') requestId, @ActorID() userId: number): Promise<Response> {
