...
export class PostController {
  ...
  @Delete('/admin/:id')
  @UseGuards(IsLoginGuard)
  async adminDeletePost(@Param('id') id: number, @ActorID() actorId: number): Promise<Response> {
    return this.postService.deletePost(id, actorId, ActorRole.ADMIN)
  }

  @Put('/admin/approve-update')
  @UseGuards(AdminModAuthGuard)
  async adminApproveUpdatePost(@Body() body: AdminApproveRequest): Promise<Response> {
