...
import { ActorID, OptionalActorID } from 'src/shares/decorators/get-user-id.decorator'
...
export class VoucherController {
  ...
  async getAllVoucher(@Query() options: GetVoucherDto, @OptionalActorID() userId: number): Promise<Response> {
    console.log(userId)
  ...
  @Put('/:voucherId')
  @UseGuards(UserAuthGuard)
  async claimVoucher(@ActorID() userId: number, @Param('voucherId') voucherId: number): Promise<Response> {
